...
const items: { type: WorkflowNodeType; label: TranslationKey; hint: TranslationKey; icon: LucideIcon; color: string }[] = [
  { type: "start", label: "palette.start", hint: "palette.startHint", icon: Play, color: "node-icon-start" },
  { type: "task", label: "palette.task", hint: "palette.taskHint", icon: ClipboardList, color: "node-icon-task" },
  { type: "approval", label: "palette.approval", hint: "palette.approvalHint", icon: Check, color: "node-icon-approval" },
  { type: "condition", label: "palette.condition", hint: "palette.conditionHint", icon: GitBranch, color: "node-icon-condition" },
  { type: "end", label: "palette.end", hint: "palette.endHint", icon: CircleCheck, color: "node-icon-end" },
];
